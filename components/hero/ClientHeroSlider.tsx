      ...
      <section className="relative h-96 md:h-[500px] lg:h-[600px] overflow-hidden bg-light-gray animate-pulse">
        ...
        <div className="relative h-full flex items-center justify-center text-center text-deep-charcoal">
          <div className="max-w-4xl px-4">
            <div className="h-16 bg-deep-charcoal/10 rounded mb-4"></div>
            <div className="h-8 bg-deep-charcoal/10 rounded mb-6 max-w-2xl mx-auto"></div>
            <div className="h-12 bg-deep-charcoal/10 rounded w-32 mx-auto"></div>
          </div>
        </div>
      </section>
    )
