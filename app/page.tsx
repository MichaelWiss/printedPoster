        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="text-center">
              ...
              <h3 className="font-body text-xl font-medium mb-2">Premium Quality</h3>
              <p className="text-warm-gray">Museum-grade printing on archival paper</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-sage-green/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-sage-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="font-body text-xl font-medium mb-2">Curated Collection</h3>
              <p className="text-warm-gray">Hand-picked designs from talented artists</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-sage-green/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-sage-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="font-body text-xl font-medium mb-2">Fast Delivery</h3>
              <p className="text-warm-gray">Carefully packaged and shipped worldwide</p>
            </div>
          </div>
        </div>
      </section>
