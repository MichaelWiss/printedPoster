    ...
    <div className='container mx-auto px-4 py-8'>
      ...
      <div className='text-center mb-12'>
        ...
        <p className='text-lg text-warm-gray max-w-2xl mx-auto'>
          This demo showcases a standard product card design with both
          &ldquo;View Details&rdquo; and &ldquo;Add to Cart&rdquo;
          functionality. The card provides clear call-to-actions and an
      ...
      <div className='bg-light-gray rounded-lg p-6 mb-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          <div className='flex items-center gap-3'>
            <div className='w-2 h-2 bg-sage-green rounded-full' />
            <span className='text-sm text-deep-charcoal'>
              Clean, accessible button hierarchy
            </span>
          </div>
        </div>
      </div>
      ...
      <div className='mt-12 bg-white border border-sage-green/20 rounded-lg p-6'>
        ...
        <div className='space-y-3 text-sm text-warm-gray'>
          <p>
            <strong>Primary Action:</strong> &ldquo;Add to Cart&rdquo; is the
            primary CTA with terracotta background
          </p>
          <p>
            <strong>Secondary Action:</strong> &ldquo;View Details&rdquo; uses
            outline style for less prominence
          </p>
          <p>
            <strong>Quantity Control:</strong> Simple +/- buttons for quick
            quantity adjustments
          </p>
          <p>
            <strong>Loading States:</strong> Visual feedback during cart
            operations
          </p>
          <p>
